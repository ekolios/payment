...
namespace Essensoft.AspNetCore.Payment.Alipay.Domain
{
    ...
    public class InsHealthSendFlowResult : AlipayObject
    {
        ...
        /// <summary>
        /// COMMON_GIFT_INSURANCE_PRODUCT_GROUP 赠险通用product组、CUSTOMER_GIFT_INSURANCE_PRODUCT_GROUP C端赠险product组、BUSINESS_GIFT_INSURANCE_PRODUCT_GROUP B端赠险product组、XHB_GIFT_INSURANCE_PRODUCT_GROUP 相互保赠险product组
        /// </summary>
