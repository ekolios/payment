...
namespace Essensoft.AspNetCore.Payment.Alipay.Domain
{
    ...
    public class MybankCreditLoantradeLoanschemeQueryModel : AlipayObject
    {
        ...
        /// <summary>
        /// 外部product码，外部机构与网商合作的方案product码，用于标识所属的合作业务，pd_code为空是必传。
        /// </summary>
        ...
        /// <summary>
        /// 基于哪个场景查询授信方案(FIXED_CREDIT:固化授信；PROD：product；APPLY：申请；BL:保理；TYZBL：通用自保理；DYNAMIC：动态授信；CREDIT_LIST_FILTER：列表过滤授信方案)
        /// </summary>
