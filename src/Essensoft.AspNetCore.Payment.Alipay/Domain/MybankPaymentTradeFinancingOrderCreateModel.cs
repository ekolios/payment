...
namespace Essensoft.AspNetCore.Payment.Alipay.Domain
{
    ...
    public class MybankPaymentTradeFinancingOrderCreateModel : AlipayObject
    {
        ...
        /// <summary>
        /// 订单扩展字段，JSON格式，key如下：  买家支付宝Id，  卖家支付宝id，  销售product码，  借款金额，  保证金金额，  还款信息：如借款期限，日利率，还款方式  样例：  {   "ALIPAY_PAYER_USER_ID": "20885656565656",//买家支付宝id   "ALIPAY_PAYEE_USER_ID": "20885998980000",//卖家支付宝id     "SALE_PD_CODE": "销售product码",      "LOAN_AMOUNT": "300",//借款金额   "DEPOSIT_AMOUNT": "100",//保证金金额   "LOAN_INFO": //还款信息   "[{\"loanTerm\":{\"term\":12,\"termUnit\":\"M\",\"instalItrv\":1,\"instalType\":\"M\"},\"loanRate\":{\"riskIntRate\":{\"termUnitCode\":\"01\",\"amount\":0.005,\"ratioUnitCode\":\"RM\"}},\"loanRepay\":{\"repayMode\":\"1\"}}]"  }  的URLEncoder.encode（UTF-8）  "LOAN_INFO": //还款信息   具体含义如下，可以下载融资的jar来组织：  [{   "loanTerm": {//还款期限    "term": 12,//总共还款期数    "termUnit": "M",//贷款期限的长度单位(必填)，一般是有年、月、日    "instalItrv": 1,    "instalType": "M"//和termUnit一致   },   "loanRate": {//还款利率    "riskIntRate": {//贷款风险利率（年化）     "termUnitCode": "01",     "amount": 0.005,     "ratioUnitCode": "RM"    }   },   "loanRepay": {//还款方式    "repayMode": "1"   }  }]
        /// </summary>
