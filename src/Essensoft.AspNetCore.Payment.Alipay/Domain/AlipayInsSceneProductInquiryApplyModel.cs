...
namespace Essensoft.AspNetCore.Payment.Alipay.Domain
{
    ...
    {
        /// <summary>
        /// 保险product的投保人,当product价格和投保人有关时候需传值
        /// </summary>
        ...
        /// <summary>
        /// 保险product码，由保险product小二分配
        /// </summary>
        [JsonPropertyName("prod_code")]
        public string ProdCode { get; set; }

        /// <summary>
        /// 投保来源渠道，由保险product小二分配
        /// </summary>
        [JsonPropertyName("source")]
        public string Source { get; set; }

        /// <summary>
        /// product险种对应的保额(金额类型，单位为分，例如100000为1000元)。product保额类型为金额时必传
        /// </summary>
